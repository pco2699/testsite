...
class TimeSlotsControllerTest < ActionController::TestCase
  ...
  test "should create time_slot" do
    assert_difference('TimeSlot.count') do
      post :create, time_slot: { date_from: @time_slot.date_from, date_to: @time_slot.date_to, user_id: @time_slot.user_id }
    end
  ...
  test "should update time_slot" do
    patch :update, id: @time_slot, time_slot: { date_from: @time_slot.date_from, date_to: @time_slot.date_to, user_id: @time_slot.user_id }
    assert_redirected_to time_slot_path(assigns(:time_slot))
  end
